...
> **🎉 February 2026 Update:** Version **1.7.17** — Polling reliability fixes (busy-poll floor), Key Vault error visibility, updated recommended ms-fabric-cli version. See [CHANGELOG.md](CHANGELOG.md) for details.
