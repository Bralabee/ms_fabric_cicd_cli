...
> **🎉 February 2026 Update:** Version **1.7.13** — Workspace safety guardrails (--safe mode, exit code 2), plus Unicode feature prefix (⚡), default folders fix, pipeline user access, inline environment overrides, and E2E validation. See [CHANGELOG.md](CHANGELOG.md) for details.
