...
> **🎉 February 2026 Update:** Version **1.7.6** — Inline environment overrides, E2E feature branch workspace validation, plus notebook content import and Jinja2 rendering. See [CHANGELOG.md](CHANGELOG.md) for details.
