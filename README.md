...
> **🎉 February 2026 Update:** Version **1.7.5** — Notebook content import, Jinja2 template rendering, thread-safe tokens, and audit summary enhancements. See [CHANGELOG.md](CHANGELOG.md) for details.
