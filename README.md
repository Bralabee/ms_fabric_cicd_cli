...
> **🎉 February 2026 Update:** Version **1.7.16** — Workspace deletion PBI API fallback (same pattern as v1.7.15 pipeline user fix). See [CHANGELOG.md](CHANGELOG.md) for details.
