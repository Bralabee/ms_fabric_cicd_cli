...
> **🎉 February 2026 Update:** Version **1.7.14** — CI isort gate, +10 unit tests (organize-folders, bulk-destroy, generate), isort/black profile alignment, and additive services exports. See [CHANGELOG.md](CHANGELOG.md) for details.
