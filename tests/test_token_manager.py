...
class TestTokenManager:
    ...
    def mock_credential(self):
        ...
        with patch("usf_fabric_cli.services.token_manager.ClientSecretCredential") as mock:
    ...
    def test_get_token_reuses_valid_token(self, manager, mock_credential, mock_access_token):
    ...
    def test_get_token_refreshes_when_near_expiry(self, manager, mock_credential, mock_access_token):
