...
class AuditLogger:
    ...
    def log_operation(self, operation: str, workspace_id: str = None, 
                     workspace_name: str = None, details: Dict[str, Any] = None,
    ...
    def log_workspace_creation(self, workspace_name: str, workspace_id: str, 
                             capacity_id: str, success: bool = True, error: str = None) -> None:
    ...
    def log_item_creation(self, item_type: str, item_name: str, workspace_id: str,
                         workspace_name: str, folder_name: str = None, 
                         success: bool = True, error: str = None) -> None:
    ...
    def log_principal_assignment(self, principal_id: str, role: str, workspace_id: str,
                               workspace_name: str, success: bool = True, error: str = None) -> None:
    ...
    def log_git_connection(self, git_repo: str, branch: str, workspace_id: str,
                          workspace_name: str, success: bool = True, error: str = None) -> None:
    ...
    def log_deployment_start(self, config_file: str, environment: str, branch: str = None) -> None:
    ...
    def log_deployment_complete(self, workspace_name: str, workspace_id: str, 
                              items_created: int, duration_seconds: float) -> None:
