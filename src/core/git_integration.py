...
class GitFabricIntegration:
    ...
    def connect_workspace_to_git(self, workspace_id: str, git_repo_url: str, 
                                branch: str = "main", directory: str = "/") -> Dict[str, Any]:
        ...
        if result["success"]:
            logger.info(f"Successfully connected workspace {workspace_id} to {git_repo_url}:{branch}")
        
        return result
    
    def get_workspace_name_from_branch(self, base_workspace_name: str, branch: str) -> str:
    ...
    def sync_workspace_with_git(self, workspace_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "success": False,
                "error": f"Error syncing workspace: {str(e)}"
            }
    ...
    def get_current_git_info(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "success": False,
                "error": f"Error getting Git info: {str(e)}"
            }